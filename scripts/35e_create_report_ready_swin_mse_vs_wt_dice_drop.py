...
OUT_PNG = (
    REPORT_DIR
    / "35e_swin_unetr_mse_vs_wt_dice_drop_report_ready.png"
)

OUT_PDF = (
    REPORT_DIR
    / "35e_swin_unetr_mse_vs_wt_dice_drop_report_ready.pdf"
)
...
def main() -> None:
    print("=" * 80)
    print("Script 35E: Report-ready Swin MSE versus WT Dice drop")
    print("=" * 80)
