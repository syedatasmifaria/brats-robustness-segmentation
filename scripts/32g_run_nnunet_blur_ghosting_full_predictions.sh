...
echo "================================================================================"
echo "Script 32G: Run nnU-Net predictions for blur and ghosting extended full evaluation"
echo "================================================================================"
...
ROOT="nnunet/temporary_degraded_tests/blur_ghosting_extended_full"
...
echo "Expected input images per condition: 296"
echo "Expected predictions per condition: 74"
echo "Expected total predictions: 740"
echo "================================================================================"
...
for CONDITION in "${CONDITIONS[@]}"; do
    ...
    if [ "$INPUT_COUNT" -ne 296 ]; then
        echo "ERROR: Expected 296 input images for $CONDITION, found $INPUT_COUNT"
        exit 1
    fi
    ...
    if [ "$PRED_COUNT" -ne 74 ]; then
        echo "ERROR: Expected 74 predictions for $CONDITION, found $PRED_COUNT"
        exit 1
    fi
done
...
echo "Expected total prediction masks: 740"
echo "================================================================================"

if [ "$TOTAL_PREDICTIONS" -ne 740 ]; then
