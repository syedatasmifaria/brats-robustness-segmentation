#!/usr/bin/env python3
"""
Script 27D: Evaluate nnU-Net extended degradation pilot predictions.
...
OUT_METRICS_CSV = RESULTS_DIR / "27d_nnunet_extended_pilot_metrics.csv"
OUT_SUMMARY_CSV = REPORT_DIR / "27d_nnunet_extended_pilot_drop_summary.csv"
OUT_SUMMARY_TXT = REPORT_DIR / "27d_nnunet_extended_pilot_drop_summary.txt"

WT_DICE_CURVE = REPORT_DIR / "27d_nnunet_extended_pilot_wt_dice_curve.png"
WT_IOU_CURVE = REPORT_DIR / "27d_nnunet_extended_pilot_wt_iou_curve.png"
WT_DICE_DROP_CURVE = REPORT_DIR / "27d_nnunet_extended_pilot_wt_dice_drop_curve.png"
WT_IOU_DROP_CURVE = REPORT_DIR / "27d_nnunet_extended_pilot_wt_iou_drop_curve.png"
...
def main():
    print("=" * 80)
    print("Script 27D: Evaluate nnU-Net extended degradation pilot")
    print("=" * 80)
    ...
    with open(OUT_SUMMARY_TXT, "w") as f:
        f.write("=" * 80 + "\n")
        f.write("Script 27D: nnU-Net extended pilot drop summary\n")
        f.write("=" * 80 + "\n\n")
